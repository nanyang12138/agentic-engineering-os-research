...
def build_verifier_report(
    ...
    verdict_evidence_ids = result.get("evidenceIds", [])
    ...
    artifact_checks = [
        ...
        artifact_check(
            result.get("id", "regression-result"),
            "regression_result",
    ...
    return verifier_report, rule_results
...
def run_fixture(fixture: Fixture, out_dir: Path) -> dict:
    ...
    verifier_report, rule_results = build_verifier_report(fixture, run_id, fixture_hash, task_spec, evidence, result, email)
